...
const CACHE = "vahtahoz-BETA-v221";
// Cache Storage общий на ORIGIN, а не на путь регистрации SW: бета (/beta/) и стабильная (/)
...
// Поэтому здесь удаляем только СВОЮ линейку версий — только "vahtahoz-BETA-*".
