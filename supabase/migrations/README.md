...
**Если пакет уже применён (прод).** Достаточно ОДНОЙ вставки — `2026-08-01_audit_round6_fixes.sql`.
...
2026-08-01_audit_round6_fixes.sql               # фиксы аудита round 6 — ПОСЛЕДНИМ
```
...
**Порядок между двумя файлами 2026-08-01 обязателен.** `audit_round6_fixes` пересоздаёт те же
