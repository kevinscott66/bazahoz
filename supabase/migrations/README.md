...
чистой базе двумя прогонами — ноль ошибок). В конце вывода — таблица диагностики: все строки
...
2026-07-31_audit_round3_sql_fixes.sql           # фиксы аудита (после всех выше)
2026-07-31_org_roles_preset_guard.sql           # пресеты org-ролей — ПОСЛЕДНИМ
```
