...
> 2. **`2026-08-12_core_rls_baseline.sql`** — на проде это no-op (всё уже есть), но файл
...
```
2026-08-12_core_rls_baseline.sql                # RLS + политики bases/base_members/profiles/tasks
