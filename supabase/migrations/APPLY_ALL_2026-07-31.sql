...
--
-- ВНИМАНИЕ: на проде пакет по 2026-08-01_zeroing_report_fixes.sql включительно уже применён.
-- Чтобы доложить только новое, достаточно ОДНОЙ вставки 2026-08-01_audit_round6_fixes.sql —
