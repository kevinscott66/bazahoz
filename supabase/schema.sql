...
-- ВАЖНО: это базовый bootstrap, а не полный актуальный production schema. После него
-- обязательно применяются миграции из migrations/README.md: они добавляют RBAC-поля,
-- org_roles, историю, recovery-таблицы, rate-limit, актуальные RLS и индексы.
-- ============================================================
